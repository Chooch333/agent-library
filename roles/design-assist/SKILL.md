...
- **Working appendix** carries: Decisions Made / Forks (open) / Gated items / Assumptions (genuinely unverifiable only) / Out of Scope. When the brief goes build-ready, Forks and Gated are empty by definition and the appendix collapses into the brief's Scope and Inputs sections.
