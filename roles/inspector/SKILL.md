...
- *Recovery:* a target file that 404s or a repo that's gone → `set_punch_status held` (author `inspector`) with a note explaining what couldn't be read; never guess.
